...
const UpdateSenior = ({}) => {
    ...
    const onPress = async () => {
        console.log("Updating seniors", account_number, first_name, last_name, birth_date, profile_picture, bio, likes, dislikes);

        // let family
        // const api = createApi()
        // family = await api.updateSenior({
        //     role: "family_member"
        // })
        // console.log("Family!")
        ...
        // return false;;
        resp = await authApi.updateSenior({
            role: "family_member",
        ...
        console.log(resp, account_number, first_name, last_name, birth_date, profile_picture, bio, likes, dislikes)
    }
            ...
            <View style={[globalstyle.rows, styles.cont]}>
                ...
                <View style={styles.inner}>
                    ...
                    <View style={styles.button}>
                        ...
                        }} style={styles.button} text="Update Senior" />
                    </View>
                </View>
            </View>
        </View>
